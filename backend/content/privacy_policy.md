...
- **Company** (referred to as either 'the Company', 'We', 'Us' or 'Our' in this Agreement) refers to ActionPaint Inc., Loremstreet 1.
...
- **Website** refers to ActionPaint, accessible from [actionpaint.mfinn.de](<actionpaint.mfinn.de>)
