      ...
      <Col className={styles.height100 + " d-flex justify-content-center"}>
        <Form className="d-flex flex-column justify-content-center" action={null}>
          <Form.Group controlId="formBasicEmail">
            ...
            <Form.Control type="user" placeholder="Question" onInput={e => setQuestionInput(e.target.value)} />
          </Form.Group>
          <Form.Group controlId="ControlTextarea1">
            <Form.Label>Answer</Form.Label>
            <Form.Control type="user" placeholder="Answer" onInput={e => SetAnswerInput(e.target.value)} />
          </Form.Group>
