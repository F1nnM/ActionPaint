...
const TitleScreen = React.forwardRef((props, ref) => (
      <Container id="TitleScreen" className={styles.fullHeight + " " + styles.backgroundImage+ " d-flex flex-column"} ref={ref}>
        ...
        <div>
          <div className={styles.scrollNotice+" text-center"}>
            <span className={styles.shadowBack + ' ' + styles.hideable + (props.tmpinView?'': ' '+styles.hidden)}>v Scroll down v</span>
          </div>
        </div>
      </Container>
)
